...
var Input = function Input(props, ref) {
  ...
  var clses = {
    input: classNames(clsPrefix, "".concat(clsPrefix, "--").concat(size), "".concat(clsPrefix, "--").concat(type), (_classNames = {}, _defineProperty(_classNames, "".concat(clsPrefix, "--hasIcon"), hasIcon), _defineProperty(_classNames, "".concat(clsPrefix, "--").concat(type, "-highlighted"), highlightable && isFocused), _classNames), className),
    ...
    textInput: classNames("".concat(clsPrefix, "-textinput"), "".concat(clsPrefix, "-textinput--").concat(size), "".concat(clsPrefix, "-textinput--").concat(type), "".concat(clsPrefix, "-textinput--").concat(align), (_classNames3 = {}, _defineProperty(_classNames3, "".concat(clsPrefix, "-textinput--").concat(type, "-disabled"), disabled), _defineProperty(_classNames3, "".concat(clsPrefix, "-textinput--").concat(size, "-multiline"), multiline), _defineProperty(_classNames3, "".concat(clsPrefix, "-textinput--wechat"), isStrictWechatMiniProgram), _defineProperty(_classNames3, "".concat(clsPrefix, "-textinput--not-bw"), !isStrictByteDanceMicroApp && !isStrictWechatMiniProgram), _defineProperty(_classNames3, "".concat(clsPrefix, "-textinput--").concat(type, "-readonly"), readOnly), _defineProperty(_classNames3, "".concat(clsPrefix, "-textinput--").concat(type, "-placeholder"), readOnly && !value && placeholder), _classNames3)),
