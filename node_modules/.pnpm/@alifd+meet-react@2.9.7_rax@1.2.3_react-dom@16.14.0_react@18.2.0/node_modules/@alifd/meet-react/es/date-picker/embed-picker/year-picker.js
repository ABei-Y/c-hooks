...
var YearPicker = /*#__PURE__*/function (_BasePicker) {
  ...
  _createClass(YearPicker, [{
    ...
    value: function getDataSource(locale) {
      ...
      var start = 1970;
      var end = 1970 + 300;
      var yearLocale = get(locale, 'locale.DatePicker.year', '年');
      if (validRange) {
        start = validRange[0].getFullYear();
        end = validRange[1].getFullYear();
      }
      return [this.filterDataSource(rangeOptions(start, end, yearLocale), function (d, it) {
        resetMonth(d);
        resetTime(d);
