...
var Dialog = function Dialog(props, ref) {
  ...
  var clses = useMemo(function () {
    var _classNames3, _classNames6, _classNames7, _classNames8, _classNames9, _classNames10;
    return {
      ...
      icon: classNames((_classNames6 = {}, _defineProperty(_classNames6, "".concat(clsPrefix, "-icon"), true), _defineProperty(_classNames6, "".concat(clsPrefix, "-icon--").concat(type), true), _defineProperty(_classNames6, "".concat(clsPrefix, "-icon--centered"), centered), _classNames6)),
