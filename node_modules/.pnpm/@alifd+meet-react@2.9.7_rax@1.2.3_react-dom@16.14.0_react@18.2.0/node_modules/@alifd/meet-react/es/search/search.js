...
var Search = function Search(props, _ref) {
  ...
  var clses = {
    search: classNames(className, (_classNames = {}, _defineProperty(_classNames, "".concat(clsPrefix), true), _defineProperty(_classNames, "".concat(clsPrefix, "--").concat(size), true), _defineProperty(_classNames, "".concat(clsPrefix, "--highlighted"), highlightable && isFocused), _classNames))
  };
