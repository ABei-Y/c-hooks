...
exports.getDefaultItemRender = getDefaultItemRender;
exports.useTouchChangeEventProps = useTouchChangeEventProps;
...
function computeValue(_ref) {
  var x = _ref.x,
    count = _ref.count,
    width = _ref.width,
    allowHalf = _ref.allowHalf;
  var stepWidth = width / count;
  var xStep = Math.floor(x / stepWidth);
  var remainder = x % stepWidth;
  if (!allowHalf) {
    return remainder ? xStep + 1 : xStep;
  }
  return xStep + (remainder / stepWidth >= 0.5 ? 1 : 0.5);
}
function getDefaultItemRender(_ref2) {
  ...
  return function (_ref3) {
    var key = _ref3.key,
      ...
      isHalfActive = _ref3.isHalfActive;
    return /*#__PURE__*/(0, _react.createElement)(_react.Fragment, null, /*#__PURE__*/(0, _react.createElement)(_icon.default, {
      name: iconType,
      size: size,
      className: isActive ? classnames.activeIcon : classnames.icon
    }), !!isHalfActive && /*#__PURE__*/(0, _react.createElement)(_view.default, {
      key: key + "-overlay",
...
function useTouchChangeEventProps(_ref4) {
  var _this = this;
  var id = _ref4.id,
    value = _ref4.value,
    onChange = _ref4.onChange,
    allowHalf = _ref4.allowHalf,
    count = _ref4.count,
    disabled = _ref4.disabled;
  var containerRectRef = (0, _react.useRef)();
  var debouncedGetContainerRect = (0, _hooks.useDebounce)(function () {
    return (0, _tslib.__awaiter)(_this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var rect;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _utils.getElementBoundingClientRect)(id);
          case 2:
            rect = _context.sent;
  ...
  (0, _react.useEffect)(function () {
    debouncedGetContainerRect();
    return function () {
      debouncedGetContainerRect.cancel();
    };
  });
  var handleChange = (0, _hooks.useDebounce)(function (x, width) {
  ...
  var handleTouch = function handleTouch(e) {
    var _a, _b;
    var touchX = (_b = (_a = e.touches) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.pageX;
    var rect = containerRectRef.current;
    if (rect && typeof touchX === 'number') {
      handleChange(touchX - rect.left, rect.width);
    }
  };
  if (disabled) {
    return {};
  }
  if (_utils.isIOS || _utils.isAndroid) {
    return {
  ...
  return {
    onClick: function handleClick(e) {
      ...
      var rect = containerRectRef.current;
      if (rect) {
        handleChange(hoverX - rect.left, rect.width);
      }
    }
  };
}