...
const LOCAL_DEP_EXT = exports.LOCAL_DEP_EXT = ['.jsx', '.tsx', '.js', '.ts'];
const LOCAL_MODULE_EXT = exports.LOCAL_MODULE_EXT = [...LOCAL_DEP_EXT, '.json'];
// local dependency extensions which will be collected
const PLAIN_TEXT_EXT = exports.PLAIN_TEXT_EXT = [...LOCAL_MODULE_EXT, '.less', '.css', '.scss', '.sass', '.styl'];
...
var _default = exports.default = analyzeDeps;